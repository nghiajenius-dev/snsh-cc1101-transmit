...
#define TIMER_PERIOD_MS 0.01		// timer resolution = 0.01ms
...
void Timer_Init(void)
{
	...
	ROM_TimerConfigure(TIMER4_BASE, TIMER_CFG_A_PERIODIC_UP);
	ROM_TimerLoadSet(TIMER4_BASE, TIMER_A, SysCtlClockGet() * TIMER_PERIOD_MS/ 1000);	//Interval: TIMER_PERIOD_MS(ms)
 ...
 * @return timer ID
 */
TIMER_ID TIMER_RegisterEvent(TIMER_CALLBACK_FUNC callback, float ms)
{
    int i;
